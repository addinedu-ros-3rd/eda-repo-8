select tt1.region, tt1.two_gen_rate*100, tt2.plastic_rate*100
...
join (select region_name,
	   			plastic / (mix_recycle + mix_burn + mix_bury + mix_etc + recycle_recycle + recycle_burn + recycle_bury + recycle_etc + food_recycle + food_burn + food_bury + food_etc) as plastic_rate
		from trash) tt2
